...
import VanEckVBILLPage from "./pages/primary-market/VanEckVBILLPage";
import BlackRockFundPage from "./pages/primary-market/BlackRockFundPage";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        {/* Primary market*/}
        <Route
          path="/primary-market/vaneck-vbill"
          element={<VanEckVBILLPage />}
        />
        ...
        <Route
          path="/investments/alternative-assets"
          element={<AlternativeAssetsPage />}
        />
        <Route
          path="/investments/registered-funds"
          element={<RegisteredFundsPage />}
        />
        <Route
          path="/solutions/institutional-tokenization"
          element={<InstitutionalTokenizationPage />}
        />
        <Route
          path="/solutions/fund-administration"
          element={<FundAdministrationPage />}
        />
      </Routes>
    </BrowserRouter>
  );
