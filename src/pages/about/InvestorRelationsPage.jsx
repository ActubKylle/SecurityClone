...
const PdfIcon = () => (
  ...
  >
    ...
    <path
      d="M2.13 24.61H23.46V27.29C23.46 27.43 23.41 27.57 23.31 27.67C23.21 27.77 23.07 27.83 22.93 27.83H2.66C2.37 27.83 2.13 27.59 2.13 27.29V24.61Z"
      fill="white"
    />
  </svg>
);
    ...
    <div className="bg-white text-[#03060D]">
      ...
      <section className="relative w-full h-[330px] md:h-[450px] lg:h-[546px] overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(0deg, #06090F 0%, rgba(6,21,53,0) 40%)",
          }}
        />
        <div className="absolute inset-0 flex flex-col z-10 justify-end items-center max-w-[1000px] mx-auto pb-12 md:pb-[100px] pt-[100px] px-5 text-white text-center gap-5">
          ...
          <p className="font-serif font-normal text-[22px] md:text-[32px] lg:text-[40px] leading-[1.2]">
            Securitize to Go Public Through Business Combination with Cantor
            Equity Partners II (NASDAQ: CEPT)*
          </p>
        </div>
      </section>

      {/* Investor Update */}
      <section className="bg-[#06090f] px-5 md:px-10 lg:px-[140px] py-[40px] md:py-[60px]">
        <div className="max-w-[1160px] mx-auto flex flex-col gap-[60px]">
          {/* TOP GRID */}
          <div className="grid grid-cols-1 lg:grid-cols-[2.1fr_0.95fr] gap-5">
            {/* LEFT FEATURE CARD */}
            <div className="bg-[#ffffff] min-h-[285px] overflow-hidden relative">
              <div className="flex h-full">
                {/* CONTENT */}
                <div className="flex flex-col justify-between p-8 lg:p-10 w-[52%]">
                  <div className="flex flex-col gap-5">
                    <span className="text-[#03060d] text-[14px] leading-none font-medium">
                      Carlos Domingo, CEO
                    </span>

                    <h2 className="font-editorial text-[#03060d] text-[48px] leading-[48px] tracking-[-0.045em]">
                      Investor
                      <br />
                      Presentation
                    </h2>
                  ...
                  <div className="flex items-center gap-3">
                    <button className="h-[42px] px-6 rounded-full bg-[#020611] text-white text-[15px] flex items-center gap-2 hover:opacity-90 transition-opacity">
                      Webcast →
                    </button>

                    <button className="h-[42px] px-6 rounded-full border border-[#03060d]/25 text-[#03060d] text-[15px] hover:bg-black/5 transition-colors">
                      Transcript ↗
                    </button>
                  </div>
                </div>
                ...
                <div className="w-[48%] relative overflow-hidden">
                  <img
                    src="/assets/about/team/carlos.webp"
                    alt="Carlos Domingo"
                    className="absolute inset-0 h-full w-300 object-cover"
                  />
                </div>
              </div>
            </div>
            ...
            <a
              href="#"
              className="bg-[#ffffff] p-8 lg:p-9 flex flex-col justify-between min-h-[285px] hover:bg-[#d3d3d3] transition-colors"
            >
              <div className="flex flex-col gap-8">
                <span className="text-[#03060d]/55 text-[14px]">
                  Jan 28, 2026
                </span>

                <h3 className="font-editorial text-[#03060d] text-[28px] leading-[34px] tracking-[-0.04em]">
                  Securitize and Cantor Equity Partners II Announce Public
                  Filing of Registration Statement on Form S-4
                </h3>
              </div>

              <span className="text-[#03060d]/70 text-[15px] flex items-center gap-2">
                Read more →
              </span>
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <a
              href="#"
              className="border border-white/10 min-h-[98px] px-8 flex items-center justify-between text-white hover:border-white/25 transition-colors"
            >
              <div className="flex items-center gap-5">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 384 512"
                  className="w-7 h-7 fill-white/85"
                >
                  <path d="M181.9 256.1c-5-16-4.9-46.9-2-46.9 8.4 0 7.6 36.9 2 46.9zm-1.7 47.2c-7.7 20.2-17.3 43.3-28.4 62.7 18.3-7 39-17.2 62.9-21.9-12.7-17.2-24.4-37.3-34.5-40.8zM86.1 428.1c0 .8 13.2-5.4 34.9-40.2-6.7 6.7-29.1 24-34.9 40.2zM248 160h136v328c0 13.3-10.7 24-24 24H24c-13.3 0-24-10.7-24-24V24C0 10.7 10.7 0 24 0h200v136c0 13.2 10.8 24 24 24zm-8 171.8c-20-12.2-33.3-29-42.7-53.8 4.5-18.5 11.6-46.6 6.2-64.2-4.3-13.9-13.6-24.9-26.4-24.6-17.7 .4-29.5 15.5-33.4 37.8-4.9 28.3-.4 64.5 12.6 96-12.6 31.1-33.8 69.7-56.9 92.9-24.8 12.2-52.6 28.1-52.6 54.3 0 13.1 8.4 21.2 19.2 21.2 31.8 0 51.2-36.2 72.5-80.8 25.5-8.5 54.1-19.1 79-23.2 21.7 12.3 47.5 19.5 64 19.5 17.2 0 31.2-6.2 31.2-19.7 0-16.8-13.1-24.4-32.3-24.4-10.7 0-26 2.4-44.2 6.8z" />
                </svg>

                <span className="font-editorial text-[22px] leading-none tracking-[-0.03em]">
                  Investor Presentation PDF
                </span>
              </div>

              <span className="text-[34px] text-white/80">→</span>
            </a>
            ...
            <a
              ...
              className="border border-white/10 min-h-[98px] px-8 flex items-center justify-between text-white hover:border-white/25 transition-colors"
            >
              <span className="font-editorial text-[22px] tracking-[-0.03em]">
                Form S-4/A
              </span>
          ...
          <p className="text-center text-[13px] text-white/35">
            *Once the business combination is effective, Securitize intends to
            trade using the ticker SECZ
          </p>
        </div>
      </section>
      {/* Ticker disclaimer (dark band) */}
      {/* <section
        className="px-5 md:px-10 pt-0 pb-10"
      ...
      >
        <div className="max-w-[1160px] mx-auto flex flex-col items-center">
          <p className="text-[14px] text-[#4F74AB] opacity-80 mb-6">
            Recent Press
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 w-full py-5 lg:py-10 px-5">
            {recentPress.map((p) => (
              ...
              >
                ...
                <p className="text-[14px] text-[#03060D] opacity-60">
                  {p.date}
                </p>
                <h3 className="text-[16px] md:text-[24px] text-[#03060D] line-clamp-4 leading-[1.25]">
                  {p.title}
                </h3>
                <a
                  href={p.href}
          ...
          <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-20">
            ...
            <div className="lg:w-1/2 w-full flex flex-col">
              {announcements.map((a, i) => (
                <div key={a.href}>
                  {i > 0 && (
                    <div className="w-full border-t border-[#03060D]/10 my-6" />
                  )}
                  <div className="flex flex-col gap-5">
                    <p className="text-[14px] text-[#03060D] opacity-60">
                      {a.date}
          ...
          <div className="flex flex-col gap-10 max-w-[650px] py-[60px] lg:py-[160px] px-5">
            ...
            <div className="flex flex-col gap-4" style={{ color: "#040F29" }}>
              <p className="text-[16px] leading-[1.5]">
                As the leading platform for tokenized real-world assets,
                Securitize is redefining how capital markets operate through
                regulated, onchain infrastructure.
              </p>
              <p className="text-[16px] leading-[1.5]">
                Backed by trusted institutional partners and a strong regulatory
                foundation, we enable compliant issuance, trading, and
                management of digital securities.
              </p>
              <p className="text-[16px] leading-[1.5]">
                Our mission is to modernize finance by bridging traditional and
                blockchain ecosystems—creating new opportunities for efficiency,
                access, and growth.
              </p>
            </div>
          </div>
